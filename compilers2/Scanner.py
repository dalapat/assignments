...
class Scanner:
    ...
    def all(self):
        ...
        try:
            ...
            while(not token.kind == 4): # while we haven't reached the end of file
        ...
        while(self.curr_position < input_text_length):
            ...
            # check if the current character is a letter
                ...
                try:
                    ...
                    token = Token(kind=1, identifier_value=v_string, # KeyError caught so it must be an identifier
                                  start_position=start, end_position=end)
                    return token
